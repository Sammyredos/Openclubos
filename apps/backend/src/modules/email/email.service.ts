...
export class EmailService {
  ...
  async sendPasswordReset(
    ...
    return this.send(
      to,
      'Password Reset Request — OpenClubOS',
      html,
  ...
  async sendRegistrationApproved(
    ...
    return this.send(
      to,
      `Approved: You're in for ${tournamentName}`,
      html,
      `Registration approved email sent to ${to}`,
    );
  }
  ...
  async sendRegistrationRejected(
    ...
    return this.send(
      ...
      `Registration Update: ${tournamentName}`,
      html,
      `Registration rejected email sent to ${to}`,
    );
  }
  ...
  async sendWaitlistNotification(
    ...
    return this.send(
      to,
      `Waitlisted: ${tournamentName}`,
      html,
      `Waitlist notification sent to ${to}`,
    );
  }
  ...
  async sendPaymentReceipt(
    ...
    return this.send(
      to,
      `Payment Receipt: ${tournamentName}`,
      html,
  ...
  async sendTournamentReminder(
    ...
    return this.send(
      to,
      `Action Required: Upcoming Tournament - ${tournamentName}`,
      html,
  ...
  async sendTournamentStarted(
    ...
    return this.send(
      to,
      `Now Active: ${tournamentName}`,
      html,
      `Tournament started email sent to ${to}`,
    );
  }
  ...
  async sendTournamentCompleted(
    ...
    return this.send(
      to,
      `Official Results: ${tournamentName} Concluded`,
      html,
      `Tournament completed email sent to ${to}`,
    );
  }
  ...
  async sendPlayerDisqualified(
    ...
    return this.send(
      to,
      `Official Notice: Disqualification from ${tournamentName}`,
      html,
      `Disqualification email sent to ${to}`,
    );
  }
  ...
  async sendPlayerStrokePenalty(
    ...
    return this.send(
      to,
      `Official Notice: Stroke Penalty in ${tournamentName}`,
      html,
      `Stroke penalty email sent to ${to} (${strokes} strokes)`,
    );
  }
  ...
  async sendAdminCredentials(
    ...
    return this.send(
      to,
      `Admin Access: ${clubName}`,
      html,
      `Admin credentials sent to ${to} for ${clubName}`,
    );
  }
  ...
  async sendAccountSuspended(
    ...
    return this.send(
      to,
      `Notice: Account Suspended at ${clubName}`,
      html,
      `Account suspended email sent to ${to}`,
    );
  }
  ...
  async sendAccountReactivated(
    ...
    return this.send(
      to,
      `Restored: Account Reactivated at ${clubName}`,
      html,
      `Account reactivated email sent to ${to}`,
    );
  }
  ...
  async sendSecurityAlert(to: string, action: string): Promise<EmailResult> {
    ...
    return this.send(
      to,
      'Security Alert: Recent Account Activity',
      html,
      `Security alert sent to ${to} | action=${action}`,
    );
  }
  ...
  async sendTournamentUpdate(
    ...
    return this.send(
      to,
      `Important Update: ${tournamentName}`,
      html,
      `Tournament update email sent to ${to} for ${tournamentName}`,
    );
  }
  // ────────────────────────────────────────────────────────────────
  ...
  async sendTournamentCutPassed(
    ...
    return this.send(
      to,
      `You Made the Cut! - ${tournamentName}`,
      html,
      `You Made the Cut email sent to ${to} for ${tournamentName}`,
    );
  }

  async sendTournamentCutMissed(
    to: string,
    tournamentName: string,
    playerName: string,
    organizerName?: string,

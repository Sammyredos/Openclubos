          ...
          {pageState === "success" ? (
            <>
              ...
              <div className="text-center mb-8">
                <div className="mx-auto w-16 h-16 rounded-full bg-emerald-50 flex items-center justify-center text-[#10b981] mb-4">
                  <CheckCircle2 className="w-8 h-8" />
                </div>
                <h1 className="text-[28px] font-bold text-[#1a2332] mb-1 tracking-tight">Password Reset!</h1>
            ...
            <>
              {/* Error State Header */}
              <div className="text-center mb-8">
                <h1 className="text-[28px] font-bold text-[#1a2332] mb-1 tracking-tight">Invalid Link</h1>
              ...
              <div className="w-full space-y-6">
                ...
                <div className="text-center">
                  <a
                    href="/login"
                    className="inline-flex items-center gap-2 text-[14px] font-bold text-gray-400 hover:text-[#10b981] transition-all duration-200 group"
                  >
            ...
            <>
              {/* Title */}
              <div className="text-center mb-8">
                <h1 className="text-[28px] font-bold text-[#1a2332] mb-1 tracking-tight">Create New Password</h1>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-5">
                ...
                <div className="space-y-2.5">
                  <label htmlFor="newPassword" className="text-[14px] font-bold text-[#1a2332] block px-1">New Password</label>
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-gray-400">
                      <Lock className="h-5 w-5 transition-colors group-focus-within:text-[#10b981]" />
                    </div>
                    <Input
                      id="newPassword"
                ...
                <div className="space-y-2.5">
                  <label htmlFor="confirmPassword" className="text-[14px] font-bold text-[#1a2332] block px-1">Confirm Password</label>
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-gray-400">
                      <ShieldCheck className="h-5 w-5 transition-colors group-focus-within:text-[#10b981]" />
                    </div>
                    <Input
                      id="confirmPassword"
                ...
                <Button
                  disabled={pageState === "loading"}
                  className="w-full h-12 bg-[#10b981] hover:bg-[#0da673] border border-emerald-600/30 text-white rounded-lg font-bold text-[15px] transition-colors flex items-center justify-center gap-3 mt-4"
                >
                  {pageState === "loading" ? (

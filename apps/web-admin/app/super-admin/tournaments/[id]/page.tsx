                ...
                {groupingsLoading ? (
                    ...
                    <div className="flex flex-col lg:flex-row gap-6">
                      ...
                      <div className="w-full lg:w-[300px] shrink-0 bg-gray-50/50 border border-gray-150 rounded-2xl p-4 shadow-sm self-start">
                        ...
                        {groupingsData.unassigned && groupingsData.unassigned.length > 0 ? (
                          ...
                          <p className="text-[11px] text-gray-400 italic mt-3 font-normal text-center py-4">All players assigned.</p>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center gap-6 py-16 text-center">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <p className="text-[13px] text-gray-500 font-normal max-w-sm">Generate automatic pairings based on registered players and handicap indices.</p>
                    </div>
                    <Button
                      onClick={handleGenerateGroupings}
                      disabled={groupingsGenerating}
                      className="bg-[#10b981] hover:bg-emerald-600 text-white rounded-xl h-11 px-6 text-[13px] font-bold gap-2"
                    >
                      {groupingsGenerating ? (

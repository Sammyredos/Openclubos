...
function ViewTournamentPageInner() {
  ...
  }, [activeTab, tournamentId, selectedDay, selectedLeaderboardDay, waitlistPage, waitlistDebouncedSearch, waitlistFilter, registrationsRefreshTrigger, selectedTournament?.id, leaderboardSortBy]);
  ...
  if (error || !selectedTournament) {
    return (
      <div className="p-8 text-center text-red-500 font-sans">
        ...
        <Button onClick={() => router.push("/super-admin/tournaments")} className="mt-4 bg-[#10b981] hover:bg-[#0da673] text-white">
          Back to Tournaments
        </Button>
      </div>
    );
  ...
  return (
    <div className="w-full max-w-full px-4 py-8 font-sans space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#e7e7e7] pb-4">
                  ...
                  <div className="flex items-center gap-3">
                    <Button
                      ...
                      variant="outline"
                      className="h-10 border-gray-200 text-gray-700 hover:bg-gray-50 gap-2 rounded-xl px-4 text-[13px] font-bold"
                    >
                      <Clock className="w-4 h-4 text-emerald-600" /> Waitlist Queue
                      {pendingWaitlistTotal > 0 && (
                        <span className="flex items-center justify-center bg-emerald-100 text-emerald-700 text-[11px] font-bold px-1.5 h-5 min-w-[20px] rounded-full">
                    ...
                    >
                      <UserPlus className="w-4 h-4" /> Register a Player
                    </Button>
                  </div>
                </div>
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          manualPaymentType === 'UNPAID'
                            ...
                            : "border-[#e7e7e7] bg-white text-gray-550 hover:border-gray-250"
                        )}
                      >
                        <div className="flex items-center gap-2">
                          <div className={cn(
                            ...
                            {manualPaymentType === 'UNPAID' && <div className="w-2 h-2 rounded-lg bg-emerald-500" />}
                          </div>
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <div className={cn(
                            ...
                            {manualPaymentType === 'CASH' && <div className="w-2 h-2 rounded-lg bg-emerald-500" />}
                          </div>
                    ...
                    {isSearchingPlayers ? (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {registerPlayerResults.map((player) => {
                          ...
                          return (
                            <div key={player.id} className="group p-4 rounded-xl border border-[#efefef] bg-[#fafafa] hover:border-emerald-200 shadow-sm hover:shadow-md transition-all duration-300 flex items-center justify-between gap-4">
                              <div className="flex items-center gap-3 min-w-0">
                                <div className="w-10 h-10 rounded-lg overflow-hidden shrink-0 border border-[#e7e7e7] bg-gray-50">
                                  <img
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4 bg-emerald-50/50 border border-emerald-100/50 rounded-xl p-4">
                  ...
                  <div className="text-right">
                    <p className="text-2xl font-black text-emerald-600 leading-none">{formatWithCommas(pendingWaitlistTotal)}</p>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                  ...
                  {selectedWaitlistIds.length > 0 && (
                    <div className="flex items-center gap-2 bg-emerald-50/50 px-4 py-2 rounded-xl border border-emerald-100">
                      <span className="text-[12px] font-bold text-emerald-700 mr-2">
                        {selectedWaitlistIds.length} selected
                      </span>
                      <Button
                        onClick={() => setIsApproveWaitlistModalOpen(true)}
                        className="h-9 bg-emerald-600 hover:bg-emerald-700 text-white text-[12px] font-bold px-4 rounded-lg shadow-sm gap-1.5"
                      >
                      ...
                      <Button
                        ...
                        variant="ghost"
                        className="h-9 text-red-600 hover:bg-red-50 hover:text-red-700 text-[12px] font-bold px-4 rounded-lg gap-1.5"
                      >
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                  ...
                  {waitlistFilter === "PENDING" && waitlist.length > 0 && (
                    <div className="flex items-center gap-2 px-2">
                      ...
                      />
                      <label htmlFor="selectAllWaitlist" className="text-[13px] font-bold text-gray-700 cursor-pointer">Select All</label>
                    </div>
                  )}
                </div>
                  ...
                  {waitlistLoading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {waitlist
                        ...
                        .map((item) => (
                          <div key={item.id} className={cn("p-4 rounded-xl border transition-all flex flex-col gap-3 group relative", selectedWaitlistIds.includes(item.id) ? "bg-emerald-50/30 border-emerald-200 shadow-sm hover:shadow-md" : "bg-[#fafafa] border-[#efefef] hover:border-emerald-200 shadow-sm hover:shadow-md")}>
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                              <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-lg overflow-hidden bg-emerald-50 border border-emerald-100 flex-shrink-0 relative">
                                  <img
                                ...
                                <div>
                                  <div className="flex items-center gap-2">
                                    <p className="text-[14px] font-bold text-gray-900 leading-tight pr-6">
                              ...
                              <div className="flex items-center gap-2 mt-5 flex-shrink-0 self-end md:self-center z-10">
                                {item.status !== "REJECTED" && (
                                  <Button
                                    onClick={() => {
                      ...
                      <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 mt-4 mb-2 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-sm">
                        <div className="flex gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-[12px] text-emerald-700 mt-0.5">Groupings have been generated. Publish them via email to notify players of their tee times.</p>
                          </div>
                        </div>
                        <Button
                          onClick={() => {
                                    ...
                                    >
                                      ...
                                      <div className="p-3 flex-1 space-y-2">
                                        {group.registrations.map((player: GroupingPlayer) => (
                                          ...
                                          >
                                            <div className="flex items-center gap-3 min-w-0">
                                              <div className="w-10 h-10 rounded-lg overflow-hidden shrink-0 border border-[#e7e7e7] bg-white shadow-sm">
                                                <img
                                              ...
                                              <div className="min-w-0">
                                                ...
                                                <div className="flex flex-wrap items-center gap-1.5 mt-1.5">
                                                  ...
                                                  {player.user?.gender && (
                                                    <span className={cn(
                                                      "text-[9px] font-bold px-1.5 py-0.5 rounded-lg uppercase tracking-tight border",
                                                  ...
                                                  {player.user?.handicap !== undefined && (
                                                    <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-lg uppercase tracking-tight bg-purple-50 text-purple-700 border border-purple-100">
                                                  ...
                                                  {/* Age Badge */}
                                                  {player.user?.dob && (
                                                    <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-lg uppercase tracking-tight bg-orange-50 text-orange-700 border border-orange-100">
                                                      {(() => {
                                                  ...
                                                  {/* PH Badge */}
                                                  <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-lg uppercase tracking-tight bg-emerald-50 text-emerald-700 border border-emerald-100">
                                        ...
                                        {Array.from({ length: Math.max(0, capacity - occupancy) }).map((_, i) => (
                                          <div key={i} className="flex items-center gap-2.5 p-2.5 rounded-xl border border-dashed border-[#e7e7e7]/50 opacity-30">
                                            <div className="w-9 h-9 rounded-lg bg-gray-50 border border-[#e7e7e7]" />
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                      {paginated.length > 0 ? (
                                        paginated.map((player: GroupingPlayer) => (
                                          ...
                                          >
                                            <div className="flex items-center gap-3 min-w-0">
                                              <div className="w-10 h-10 rounded-lg overflow-hidden shrink-0 border border-[#e7e7e7]">
                                                <img
                                                  src={player.user?.profilePhoto || `https://api.dicebear.com/7.x/avataaars/svg?seed=${encodeURIComponent(player.user?.email || player.id)}`}
                                                  alt=""
                                                  className="w-full h-full object-cover"
            ...
            {activeTab === "leaderboard" && (
              <div className="space-y-6 animate-in fade-in duration-500">
                ...
                <div className="flex items-center justify-between pb-2 border-b border-[#e7e7e7]">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-[11px] font-bold text-emerald-600 bg-emerald-50 px-3 py-1.5 rounded-lg border border-emerald-100 flex items-center gap-2 shadow-sm">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pt-2">
                  <div className="space-y-1">
                    <h3 className="text-lg font-bold text-gray-900 flex items-center gap-2">
                      Live Standings
                      <span className="text-[10px] font-bold bg-emerald-50 text-emerald-600 px-2 py-0.5 rounded-lg border border-emerald-100 uppercase">
                        Live
                      </span>
                    </h3>
                ...
                {leaderboardLoading ? (
                  ...
                  if (filteredData.length === 0 && q) {
                    return (
                      <div className="bg-white border border-[#e7e7e7] rounded-xl shadow-sm p-16 text-center">
                            ...
                            {filteredData.slice((leaderboardPage - 1) * leaderboardPerPage, leaderboardPage * leaderboardPerPage).map((entry, index) => {
                              ...
                              return (
                                <tr key={entry.user.id} className="hover:bg-gray-50/50 transition-colors group">
                                  <td className="px-6 py-4 text-center">
                                    <div className="flex items-center justify-center">
                                      {entry.status === "DISQUALIFIED" ? (
                                        <span className="text-[10px] font-bold text-red-500 bg-red-50 px-2 py-0.5 rounded-lg border border-red-100 uppercase tracking-tight">DQ</span>
                                      ) : rank === 1 ? (
                                  ...
                                  <td className="px-6 py-4">
                                    <div className="flex items-center gap-3">
                                      <div className="w-9 h-9 rounded-lg overflow-hidden border border-[#e7e7e7] bg-white shadow-sm shrink-0">
                                        <img
                                    ...
                                    if (isAfterCut && missedCut) {
                                      return (
                                        <td key={`r-${i}`} className="px-6 py-4 text-center">
                                          <span className="text-[10px] font-bold text-red-500 bg-red-50 px-2 py-0.5 rounded-lg uppercase tracking-tight" title="Missed Cut">MC</span>
                                        </td>
                                      );
                                    }
                                  ...
                                  <td className="px-6 py-4 text-center">
                                    <div className="flex flex-col items-center justify-center gap-1">
                                      ...
                                      {entry.extraStrokes > 0 && (
                                        <span className="text-[9px] font-bold text-red-500 bg-red-50 px-1.5 py-0.5 rounded-md uppercase border border-red-100 tracking-tight whitespace-nowrap" title={`${entry.extraStrokes} Penalty Strokes`}>
                                  ...
                                  <td className="px-6 py-4 text-center">
                                    <span className="text-[11px] font-bold text-gray-400 bg-gray-50 px-2 py-0.5 rounded-lg border border-[#e7e7e7]">
      ...
      <Modal
        ...
        title={selectedWaitlistIds.length > 1 ? "Approve Players?" : "Approve Player?"}
        footer={
          <>
            <Button variant="outline" onClick={() => setIsApproveWaitlistModalOpen(false)} className="rounded-lg font-bold">
              Cancel
            </Button>
            <Button
              className="rounded-lg font-bold px-8 text-white border bg-emerald-500 hover:bg-emerald-600 border-emerald-600/30"
      ...
      <Modal
        ...
        footer={
          <>
            <Button variant="outline" onClick={() => setIsRemoveWaitlistModalOpen(false)} className="rounded-lg font-bold">
              Cancel
            </Button>
            <Button
              className="rounded-lg font-bold px-8 text-white border bg-red-500 hover:bg-red-600 border-red-600/30"

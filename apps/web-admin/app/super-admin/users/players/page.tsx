        ...
        <div className="w-full bg-white rounded-lg shadow-[0px_0px_4px_0px_rgba(0,0,0,0.15)] overflow-x-auto">
          <div className="flex items-center justify-between p-8 min-w-max gap-12 font-sans">
            ...
            <div className="flex flex-col justify-start items-start gap-3.5 flex-1">
              <div className="flex justify-start items-center gap-3.5">
                <div className="text-zinc-700 text-[15px] font-medium whitespace-nowrap">Total Players</div>
              </div>
            ...
            <div className="flex flex-col justify-start items-start gap-3.5 flex-1">
              <div className="flex justify-start items-center gap-3.5">
                <div className="text-zinc-700 text-[15px] font-medium whitespace-nowrap">Active Players</div>
            ...
            <div className="flex flex-col justify-start items-start gap-3.5 flex-1">
              <div className="flex justify-start items-center gap-3.5">
                <div className="text-zinc-700 text-[15px] font-medium whitespace-nowrap">Total Markers</div>
                <div className="px-2 py-1 bg-emerald-50 rounded-lg flex justify-center items-center gap-1 shrink-0 whitespace-nowrap">
                  <div className="text-[#15803D] text-xs font-medium">
                    {stats.totalUsers ? `${Math.round(((stats.roles?.MARKER || 0) / stats.totalUsers) * 100)}% of total` : "0%"}
                  </div>
                </div>
              </div>
              <div className="text-[#15803D] text-3xl font-bold">{formatNumber(stats.roles?.MARKER || 0)}</div>
              <div className="text-zinc-500 text-sm font-normal">Registered Markers</div>
            </div>
                      ...
                      <td className="px-6 py-5">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          >
                            ...
                            <span className="text-[13px] font-normal leading-none">View</span>
                          </button>

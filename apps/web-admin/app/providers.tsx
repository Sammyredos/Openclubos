      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-300">
        ...
        <div className="flex flex-col items-center gap-4 px-8 pt-10 pb-6 border-b border-gray-50">
          <div className="relative w-20 h-20 flex items-center justify-center">
            ...
            <span className={cn('relative text-[16px] font-normal tabular-nums transition-colors', isUrgent ? 'text-red-500' : 'text-gray-800')}>
              {countdown}
            </span>
          </div>
          <div className="text-center">
            ...
            <p className="text-[14px] text-gray-500 mt-1">
              ...
              <span className={cn('font-normal', isUrgent ? 'text-red-500' : 'text-gray-700')}>{countdown}s</span>.
            </p>
          </div>
        </div>
        {/* Info banner */}

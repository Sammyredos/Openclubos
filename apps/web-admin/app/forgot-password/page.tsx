            ...
            <>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-5">
                ...
                <div className="space-y-2.5">
                  <label htmlFor="reset-email" className="text-[14px] font-bold text-[#1a2332] block px-1">Email address</label>
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-gray-400">
                      <Mail className="h-5 w-5 transition-colors group-focus-within:text-[#10b981]" />
                    </div>
                    <Input
                      id="reset-email"
                      type="email"
                ...
                <div className="pt-4 text-center">
                  <a
                    href="/login"
                    className="inline-flex items-center gap-2 text-[14px] font-bold text-[#10b981] hover:no-underline transition-all duration-200 group"
                  >
            ...
            <>
              ...
              <div className="w-full space-y-6">
                <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-5">
                  <p className="text-[13px] text-emerald-800 leading-relaxed text-center font-medium">
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full h-12 border-gray-100 text-[#10b981] font-bold hover:bg-emerald-50 rounded-xl"
                >
                  Resend Email
                </Button>

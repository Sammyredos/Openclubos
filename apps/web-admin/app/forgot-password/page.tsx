              ...
              <>
                <div className="flex flex-col items-center text-center">
                  ...
                  <button
                    ...
                    className="w-full bg-white border-[3px] border-[#111111] py-4 px-6 flex items-center justify-center font-medium capitalize text-[1.125rem] shadow-[4px_4px_0_#15803D] transition-all hover:-translate-x-1 hover:-translate-y-1 hover:shadow-[6px_6px_0_#15803D] mb-6"
                  >
                    Resend Email
                  </button>
